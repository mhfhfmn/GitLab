...
# config.vm.box = "https://storage.yandexcloud.net/dtomin-netology/netology_8-2_jenkins_v3_go16.box"  #!!!how to connect to VM: ssh netology@192.168.56.10  pass: netology
  ...
  config.vm.provider "hyperv" do |h|
    h.memory = 6072        # память в MB
    h.cpus = 3             # количество ядер
    h.vmname = "GitLab"      # имя в Hyper-V менеджере
    # Указать конкретный коммутатор (опционально)
    # h.virtual_switch_name = "External Switch"
  end
